...
public class Class13_DP2 {
	 ...
	 * the end of the array, return -1. Assumptions The given array is not null
	 ...
	 * position (you can only jump towards the end of the array). Determine the
	 * minimum number of jumps you need to jump out of the array. By jump out,
	 * it means you can not stay at the end of the array. Return -1 if you can
	 * not do so. Assumptions The given array is not null and has length of at
