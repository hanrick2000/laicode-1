...
public class Class1 {
	...
	/*
	 * Task1 Selection Sort Data Structure Given an array of integers, sort the
	 * elements in the array in ascending order. The selection sort algorithm
	...
	/*
	 * task2 Move 0s To The End I Easy Data Structure Given an array of
	 ...
	 * 
	 * {1} --> {1} {1, 0, 3, 0, 1} --> {1, 3, 1, 0, 0} or {1, 1, 3, 0, 0} or {3,
	 * 1, 1, 0, 0}
	 */

	/*
	 * task3 Rainbow Sort Fair Data Structure Given an array of balls, where the
	...
	/*
	 * task4 Merge Sort Fair Recursion Given an array of integers, sort the
